...
import { TABLE_NAME_ALL_BOOKMARKS, UPDATE_BUTTON_ROLE_NAME } from "../../constants/constants";
import {
  ...
  describe("ブックマークが選択されている場合", () => {
    ...
    describe("エラーメッセージが出力される場合", () => {
      ...
      it("同じURLを指定された場合には409を返す。", async () => {
        ...
        const table = await screen.findByRole("table", { name: TABLE_NAME_ALL_BOOKMARKS });
