...
ブックマークが選択されているときに、キーワードを入力するテキストボックスと「追加」ボタンが表示されます。いまの段階では、テキストボックスに入力して「追加」ボタンをクリックしても、なにも実行されません。
...
| ------------------------------ | ---------------- | -------------------------------------------------------------------------------- |
| ブックマークにキーワードを設定 | 201 Created      | { "keyword_id": 10, "keyword_name": "プログラミング", "bookmark_keyword_id": 1 } |
| 指定されたブックマークがない   | 404 Not Found    | { "message": "指定されたブックマークがありません。" }                            |
| キーワードが既に登録されている | 409 Conflict     | { "message": "指定されたキーワードは既に登録されています。" }                    |
